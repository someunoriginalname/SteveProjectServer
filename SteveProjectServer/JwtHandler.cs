...
namespace SteveProjectServer
{
    //We are going to pass 
    public class JwtHandler(IConfiguration configuration, UserManager<PublisherUser> userManager)
    {
        ...
        public async Task<JwtSecurityToken> GetTokenAsync(PublisherUser user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(PublisherUser user)
        {
